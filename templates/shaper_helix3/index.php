...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154203084-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-154203084-1');
        </script>
        ...
        ?>
        <script>
            if(window.location.href == "http://nutrizioneconsapevole.net/" 
            || window.location.href == "http://nutrizioneconsapevole.net") {
                window.location.href = "http://nutrizioneconsapevole.net/index.html";
            }
        </script>
    </head>
